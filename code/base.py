...
class Faction1Base(Base):
    ...
    def __init__(self):
        ...
        self.factory = {
                        ...
                        "Ultra Unit 1": unit_group_factory.Faction1UltraUnit1Factory(),
                        "Ultra Unit 2": unit_group_factory.Faction1UltraUnit2Factory(),
                        "Ultra Unit 3": unit_group_factory.Faction1UltraUnit3Factory(),
                        "Super Unit": unit_group_factory.Faction1SuperUnitFactory()
                        }
...
class Faction2Base(Base):
    ...
    def __init__(self):
        ...
        self.factory = {
                        ...
                        "Ultra Unit 1": unit_group_factory.Faction2UltraUnit1Factory(),
                        "Ultra Unit 2": unit_group_factory.Faction2UltraUnit2Factory(),
                        "Ultra Unit 3": unit_group_factory.Faction2UltraUnit3Factory(),
                        "Super Unit": unit_group_factory.Faction2SuperUnitFactory()
                        }
        self.improvement_options = {
                                    "Improvement 1": 100, 
                                    "Improvement 2": 100, 
